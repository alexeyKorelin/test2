...
class Description extends Component {
  ...
  render() {
    const {className, description, archived, locales: {t}, togglerClass} = this.props;
    ...
    return (
      ...
      >
        ...
        {this.state.togglerShowed &&
          <button className={cx(styles.button, togglerClass)} onClick={this.toggle}>
...
Description.displayName = 'Modules/Ad/Description';
